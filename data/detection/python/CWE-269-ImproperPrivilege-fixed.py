...
class UserAccountManager:
    def __init__(self, user_roles, system_info, authorized_users):
    ...
    def promote_user_role(self, username):
        ...
        if current_role == "user" and username in self.authorized_users:
...
def main():
    ...
    user_manager = UserAccountManager(roles, system_info, authorized_users)

    dummy_logic_processor(10, 30)

    user_manager.manage_role("alice", "promote")
